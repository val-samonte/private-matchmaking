...
export declare const DELEGATE_PDA_DISCRIMINATOR: Uint8Array<ArrayBuffer>;
export declare function getDelegatePdaDiscriminatorBytes(): ReadonlyUint8Array<ArrayBuffer>;
...
export type DelegatePdaInstructionDataArgs = {
    accountType: AccountTypeArgs;
};
export declare function getDelegatePdaInstructionDataEncoder(): Encoder<DelegatePdaInstructionDataArgs>;
export declare function getDelegatePdaInstructionDataDecoder(): Decoder<DelegatePdaInstructionData>;
export declare function getDelegatePdaInstructionDataCodec(): Codec<DelegatePdaInstructionDataArgs, DelegatePdaInstructionData>;
...
export declare function getDelegatePdaInstruction<TAccountBufferPda extends string, TAccountDelegationRecordPda extends string, TAccountDelegationMetadataPda extends string, TAccountPda extends string, TAccountPayer extends string, TAccountValidator extends string, TAccountOwnerProgram extends string, TAccountDelegationProgram extends string, TAccountSystemProgram extends string, TProgramAddress extends Address = typeof RPS_GAME_PROGRAM_ADDRESS>(input: DelegatePdaInput<TAccountBufferPda, TAccountDelegationRecordPda, TAccountDelegationMetadataPda, TAccountPda, TAccountPayer, TAccountValidator, TAccountOwnerProgram, TAccountDelegationProgram, TAccountSystemProgram>, config?: {
    programAddress?: TProgramAddress;
}): DelegatePdaInstruction<TProgramAddress, TAccountBufferPda, TAccountDelegationRecordPda, TAccountDelegationMetadataPda, TAccountPda, TAccountPayer, TAccountValidator, TAccountOwnerProgram, TAccountDelegationProgram, TAccountSystemProgram>;
export type ParsedDelegatePdaInstruction<TProgram extends string = typeof RPS_GAME_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = {
...
export declare function parseDelegatePdaInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedDelegatePdaInstruction<TProgram, TAccountMetas>;
